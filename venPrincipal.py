...
class Ui_venPrincipal(object):
    def setupUi(self, venPrincipal):
        ...
        self.cmbProvincia_2 = QtWidgets.QComboBox(parent=self.pesClientes)
        self.cmbProvincia_2.setMinimumSize(QtCore.QSize(160, 0))
        self.cmbProvincia_2.setObjectName("cmbProvincia_2")
        self.gridLayout_2.addWidget(self.cmbProvincia_2, 3, 9, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.panPrincipal, 0, 0, 1, 1)
