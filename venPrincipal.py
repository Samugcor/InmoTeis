...
class Ui_venPrincipal(object):
    def setupUi(self, venPrincipal):
        ...
        self.panPrincipal.setMinimumSize(QtCore.QSize(1124, 0))
        ...
        self.horizontalLayout_6.addWidget(self.txtApellidosCliente)
        ...
        self.horizontalLayout_5.addWidget(self.txtDniCliente)
        ...
        self.horizontalLayout_8.addWidget(self.txtDirecionCliente)
